				...
				<div class="col-xl-12">
					<div class="page-title-box">
						...
						<ol class="breadcrumb float-right">
							...
							<li class="breadcrumb-item active"><a>Ubah Data</a></li>
						</ol>
				...
				<div class="col-md-6 col-sm-6">
					<div class="card-box">
						<form class="" method="POST" action="">
							<h5 class="text-semi-bold pb-2">Ubah data<br>User</h5>

							<div class="form-group row">
								<label for="nig" class="col-md-3 col-sm-12 col-form-label">Nomor Induk</label>
								<input class="form-control" type="hidden" id="id" name="id" autocomplete="off" value="<?= $users['id'] ?>">
								<div class="col-md-9 col-sm-12 my-auto">
									<input class="form-control" type="text" id="nik" name="nik" autocomplete="off" value="<?= $users['nik'] ?>">
							...
							<div class="form-group row">
								...
								<div class="col-md-9 col-sm-12 my-auto">
									<input class="form-control" type="text" id="nama" name="nama" autocomplete="off" value="<?= $users['nama'] ?>">
							...
							<div class="form-group row">
								...
								<div class="col-md-9 col-sm-12 my-auto">
									<input class="form-control" type="text" id="alamat" name="alamat" autocomplete="off" value="<?= $users['alamat'] ?>">
							...
							<div class="form-group row">
								...
								<div class="col-md-9 col-sm-12 my-auto">
									<input class="form-control" type="text" id="tlp" name="tlp" autocomplete="off" value="<?= $users['telp'] ?>">
							...
							<div class="pt-1 d-flex justify-content-end">
								...
								<button type="submit" class="btn btn-warning btn-raised ml-1">Ubah</a>
							</div>
						</form>
					</div>
				</div>
